...
export const emailVerification = (_email) => {

    const emailRegex = "(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|\"(?:[\x01-\x08\x0b\x0c\x0e-" +
    ...
    const _r = _email.match(emailRegex);
    if(_r === null){
        return Codes.INVALID_FORMAT;
    }
